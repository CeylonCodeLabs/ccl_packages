...
class CCLFilledInputBorder extends InputBorder {
  ...
  @override
  CCLFilledInputBorder copyWith(
      {BorderSide? borderSide, BorderRadius? borderRadius}) {
    return CCLFilledInputBorder(
  ...
  @override
  CCLFilledInputBorder scale(double t) {
    return CCLFilledInputBorder(borderSide: borderSide.scale(t));
  }
